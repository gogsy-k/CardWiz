  ...
  return (
    <section className="mx-auto max-w-5xl px-5 pb-4">
      <div className="relative overflow-hidden rounded-3xl border border-accent/40 bg-surface2 p-8 text-center sm:p-10">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_50%_80%_at_50%_0%,rgba(203,166,247,0.14),transparent_70%)]" />
        <div className="relative">
          ...
          <Link
            href="/find-my-card"
            className="mt-6 inline-block rounded-xl bg-accent px-6 py-3.5 text-sm font-bold text-bg transition-colors hover:bg-blue"
          >
            {t("quiz_teaser_cta")}
          </Link>
        </div>
